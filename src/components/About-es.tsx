...
const AboutEs = () => {
  ...
  return (
    <section id="acerca" className="section-padding bg-gray-100 relative overflow-hidden">
      {/* Neural Network Background - Very subtle for light background */}
      <div className="absolute inset-0 opacity-20" id="neural-network-es"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-white bg-opacity-95 rounded-lg p-6 backdrop-blur-sm border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center space-x-4 mb-4">
                  <div className="w-3 h-3 bg-blue-400 rounded-full animate-pulse"></div>
                  <span className="text-blue-600 font-semibold text-lg">Los Nombres</span>
                </div>
                <p className="text-gialoma-darkgray text-lg">
                  <span className="text-blue-600 font-bold">Gianro</span> + <span className="text-purple-600 font-bold">Paloma</span> = <span className="text-gialoma-gold font-bold text-xl">GIALOMA</span>
                </p>
              </div>
              ...
              <div className="bg-white bg-opacity-95 rounded-lg p-6 backdrop-blur-sm border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <span className="text-yellow-600 font-semibold text-lg">La Base</span>
                </div>
                <p className="text-gialoma-darkgray text-lg">
                  "<span className="text-yellow-600 font-bold">Loma</span>" representa <span className="text-yellow-600">estabilidad</span> y <span className="text-yellow-600">crecimiento</span>
                </p>
              </div>
              ...
              <div className="bg-white bg-opacity-95 rounded-lg p-6 backdrop-blur-sm border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gialoma-darkgray text-lg">
                  <span className="text-purple-600">IA</span> + <span className="text-orange-600">Diseño Humano</span> = <span className="text-gialoma-gold font-bold">Soluciones de Vida</span>
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white bg-opacity-95 rounded-xl p-8 backdrop-blur-sm border border-gray-200 shadow-lg">
                <div className="text-center text-gialoma-black">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="bg-blue-50 rounded p-4 border border-blue-200">
                      <div className="text-blue-600 font-semibold">Tecnología IA</div>
                    </div>
                    <div className="bg-purple-50 rounded p-4 border border-purple-200">
                      <div className="text-purple-600 font-semibold">Enfoque Humano</div>
                    </div>
                    <div className="bg-yellow-50 rounded p-4 border border-yellow-200">
                      <div className="text-yellow-600 font-semibold">Automatización</div>
                    </div>
          ...
          <div className="text-center">
            <div className="bg-white bg-opacity-95 rounded-xl p-8 backdrop-blur-sm border border-gray-200 shadow-lg max-w-4xl mx-auto">
