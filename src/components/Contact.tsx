    ...
    <section id="contact" className="section-padding bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          {/* Contact Information Card - Optimally sized */}
          <div className="bg-gray-50 p-9 rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:bg-gray-100/80">
            ...
            <div className="mt-9 bg-white p-7 rounded-lg shadow-sm">
              <h4 className="font-semibold text-gialoma-black mb-5 text-center text-xl">Connect with Our Founders</h4>
            ...
            <div className="mt-7 bg-white p-7 rounded-lg shadow-sm">
