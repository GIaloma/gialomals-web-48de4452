...
const CookieBanner = () => {
  ...
  const checkExistingConsent = () => {
    ...
    if (!hasConsent) {
      ...
      }, 2000); // Delayed to not interrupt UX
    } else {
      try {
        ...
        <div className="container mx-auto px-4 py-4 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 lg:flex-nowrap">
              ...
              >
                {bannerState.isProcessing ? '...' : '✓ Continue'}
              </Button>
              <Button
              ...
              >
                {bannerState.isProcessing ? '...' : 'Analytics Only'}
              </Button>
              <Button
                onClick={optOutAll}
                disabled={bannerState.isProcessing}
              ...
              >
                {bannerState.isProcessing ? '...' : 'Opt Out'}
              </Button>
              <Button
                onClick={openModal}
                disabled={bannerState.isProcessing}
              ...
              >
                ...
                {bannerState.isProcessing ? '...' : 'Customize'}
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-[60] bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end gap-3">
              ...
              >
                {bannerState.isProcessing ? 'Saving...' : 'Essential Only'}
              </Button>
              <Button
              ...
              >
                {bannerState.isProcessing ? 'Saving...' : 'Save Preferences'}
              </Button>
            </div>
          </div>
        </div>
