...
const BookPopupEs: React.FC<BookPopupEsProps> = ({ onClose }) => {
  ...
  const openBookPage = () => {
    // Open Spanish book landing page in a new tab
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md relative overflow-hidden animate-fade-in-up">
        ...
        <div className="p-6">
          <div className="flex items-center justify-center mb-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-gialoma-black">¡Nuevo Lanzamiento!</h2>
              <p className="text-sm text-gialoma-darkgray">Transforma tu Estrategia Tecnológica</p>
            </div>
          </div>
          
          <div className="space-y-4 mt-4">
            <p className="text-gialoma-darkgray">
              Descubre estrategias probadas para aprovechar la IA y automatización para el crecimiento empresarial en nuestro último libro: <span className="font-semibold">Transformación Digital Simplificada</span>.
            </p>
            
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-md">
              <div>
                <p className="text-sm text-gray-500">Precio Especial de Lanzamiento</p>
